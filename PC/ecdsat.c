//compiled with gcc -g -lssl -UOPENSSL_NO_EC ecdsat.c -lcrypto
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    ECDSA_SIG *signature = ECDSA_do_sign(hash, strlen(hash) - 1, eckey);
                    if (NULL == signature)
                    {
                    ...
                    else
                    {
                        ...
                        int verify_status = ECDSA_do_verify(hash, strlen(hash) - 1, signature, eckey);
                        const int verify_success = 1;

                        // printf("%d\n", strlen(hash));
                        // printf("%d\n", sizeof(hash));
                        // printf("%d\n", sizeof(hash)/8);
                        // printf("%d\n", sizeof(hash)/sizeof(unsigned char));
